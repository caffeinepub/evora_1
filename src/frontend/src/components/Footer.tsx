...
export default function Footer() {
  ...
  return (
    <footer
      ...
      style={{
        background:
          "linear-gradient(180deg, oklch(10 0.04 285) 0%, oklch(8 0.06 290) 100%)",
      }}
    >
      <div
        className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[800px] h-48 blur-3xl opacity-10"
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 pt-8">
          <p className="text-xs" style={{ color: "oklch(40 0.04 285)" }}>
